...
console.log("\n  Attendance rules (monthly-quota model):");
require("./attendance-logic.test.js")(t);

console.log("\n  Multi-course rules (full fee per course, payout per course):");
require("./multicourse-logic.test.js")(t);

console.log("\n  Family accounts (one login, combined fees):");
require("./family-logic.test.js")(t);
